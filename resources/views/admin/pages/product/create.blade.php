            ...
            function createFormRow() {
                ...
                for (var key in selectedOptions) {
                    if (selectedOptions.hasOwnProperty(key)) {
                        ...
                        formRow +=
                            `<div class="form-group" style="width: 10%;"><input type="${type}" class="form-control float-right w-100" placeholder="${key}"></div>`;
                    }
                }
                formRow +=
                    `<div class="form-group" style="width: 10%;"><input type="number" class="form-control float-right w-100" placeholder="Số lượng"></div>`;
                formRow +=
                    `<div class="form-group" style="width: 10%;"><input type="number" step="0.01" min="0" class="form-control float-right w-100" placeholder="Nhập giá tiền"></div>`;
                formRow +=
                    `<div class="form-group float-right"><i class="fas fa-fw fa-trash float-right trash-icon"></i></div>`;
                formRow += `</div>`;
                return formRow;
            }
