                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="variants-container">
                                                @foreach ($variants as $variant)
                                                    ...
                                                    <div class="form-row d-flex justify-content-start" id="variant_{{$variant->id}}">
                                                        @foreach ($variantValues as $key => $item)
                                                            @if ($key == 'color')
                                                                ...
                                                                <div class="form-group"
                                                                    style="width: 10%; margin-right: 1%;">
                                                                    <label for="slugCategories">{{ $key }}</label>
                                                                    <img src="{{asset('storage/' .$item)}}" style=" width: 100px;height: 20%;" class="progressive-img_full">
                                                                </div>
                                                            @else
                                                                <div class="form-group"
                                                                    style="width: 10%; margin-right: 1%;">
                                                        ...
                                                        @endForeach
                                                        <div
                                                            class="form-group float-right"style="width: 10%; margin-right: 1%;">
                                                            ...
                                                            onclick="deleteVariant('{{ route('cp-admin.products.variant.delete', ['product_id' => $Product->id,'id'=> $variant->id]) }}', {{$variant->id}})"
                                                                style="    margin-top: 28%;"><i class="fas fa-fw fa-trash"></i></div>
                                                        </div>
                                                @endForeach
                                            </div>
                                        </div>
        ...
        $(document).ready(function() {
            ...
            $('#addVariant').click(function() {
                ...
                variantHtml +=
                    ...
                    variantHtml +=
                    `<div class="form-group" style="width: 15%; margin-right: 1%;"><label for="slugCategories">Image</label><input type="file" step="0.01" min="0" name="variants[${randomStr}][image]" class="form-control float-right w-100" placeholder="Ảnh"></div>`;
                variantHtml +=
