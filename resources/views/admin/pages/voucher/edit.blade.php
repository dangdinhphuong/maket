...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{route('cp-admin.voucher.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> Danh mục</a>
</div>

<div class="card shadow mb-4 ">
    <div class="card-body">
        <div class="table-responsive">
            <form class="user" action="{{ route('cp-admin.voucher.update',[ 'id' => $sales->id ]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                    <div class="col-sm-12 mb-3 mb-sm-0">
                        <label for="nameCategories">Mã giảm <span class="text-danger">(*)</span></label>
                        <input type="text" class="form-control form-control-user" id="code"  value="{{ $sales->code }}" name="code" id="nameCategories" placeholder="Mã giảm ...">
                        @error('code')
                    ...
                    @php $products_id = json_decode($sales->products_id , true) @endphp
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="datetime-local" name="time_start" value="{{ $sales->time_start }}" class="form-control"placeholder="Thời gian bắt đầu">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="datetime-local" name="time_end" value="{{ $sales->time_end }}"class="form-control"placeholder="Thời gian Kết thúc">
