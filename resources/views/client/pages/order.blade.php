            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        ...
                        <div class="card mb-5" data-toggle="modal" data-target=".bd-example-modal-lg-{{$orderDetail->id}}">
                            <div class="card-header d-flex justify-content-between">
                                    ...
                                    <div class="Koi0Pw">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="16" fill="none">
                                            ...
                                            <defs>
                                                ...
                                                <clipPath id="clip1">
                                                    <path fill="#fff" d="M0 0h7v16H0z" transform="translate(59)"></path>
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </div>
                                    <div class="UDaMW3" tabindex="0">{{ $orderDetail->productVariant->product->User->fullname }}</div>

                                    <a class="Mr26O7" href="{{route('order_detail',['id'=>$orderDetail->order->id])}}">
                                ...
                                <div class="jgIyoX" style="    align-items: center;display: flex; padding: 0 0 0 10px;">
                                    <div class="LY5oll"
                                        ...
                                        <a class="lXbYsi"
                                           href="/user/purchase/order/163843651248456?type=6"><span
                                                class="O2yAdQ">
                                                <svg enable-background="new 0 0 15 15"
                                                     viewBox="0 0 15 15" x="0" y="0"
                                                     class="shopee-svg-icon icon-free-shipping-line"><g><line
                                                            fill="none" stroke-linejoin="round" stroke-miterlimit="10"
                                                            x1="8.6" x2="4.2" y1="9.8" y2="9.8"></line><circle cx="3"
                                                                                                               cy="11.2"
                                                                                                               fill="none"
                                                                                                               r="2"
                                                                                                               stroke-miterlimit="10"></circle><circle
                                                            cx="10" cy="11.2" fill="none" r="2"
                                                            stroke-miterlimit="10"></circle><line fill="none"
                                                                                                  stroke-miterlimit="10"
                                                                                                  x1="10.5" x2="14.4"
                                                                                                  y1="7.3"
                                                                                                  y2="7.3"></line><polyline
                                                            fill="none" points="1.5 9.8 .5 9.8 .5 1.8 10 1.8 10 9.1"
                                                            stroke-linejoin="round" stroke-miterlimit="10"></polyline><polyline
                                                            fill="none" points="9.9 3.8 14 3.8 14.5 10.2 11.9 10.2"
                                                            stroke-linejoin="round"
                                                            stroke-miterlimit="10"></polyline></g></svg> Giao hàng thành công</span></a>
                                    ...
                                    <div class="bv3eJE" tabindex="0">{{ App\Common\Constants::STATUS_ORDER[$orderDetail->order->status] }}</div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="shoping__cart__item d-flex justify-content-start" style="">
                                    <img style="width: 8%; height:88px"
                                         src="http://maket.test/storage/images/products/wgCFa8LdBHPJ7pevZzznjK2CLMVZCbF2gYxrGXoj.jpg"
                                    ...
                                    <div style="margin-left: 2%;     width: 10%;">
                                        <h5>
                                            <p class="text-danger">{{ number_format($orderDetail->price, 0, ',', '.') . " ₫"   }}</p>
                                        </h5>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer text-muted">
                                <div class="NWUSQP"><span class="R_ufN9"><div class="afBScK" tabindex="0"><svg
                                                width="16" height="17" viewBox="0 0 253 263" fill="none"
                                                xmlns="http://www.w3.org/2000/svg"><title>Shopee Guarantee</title><path
                                                    ...
                                                    fill="#ee4d2d"></path><path fill-rule="evenodd" clip-rule="evenodd"
                                                                                ...
                                                                                fill="#fff"></path></svg></div></span><label
                                        class="juCcT0">Thành tiền:</label>
                                    <div class="t7TQaf" tabindex="0" aria-label="Thành tiền: {{ number_format($orderDetail->price * $orderDetail->quantity, 0, ',', '.') . " ₫"   }}">{{ number_format($orderDetail->price * $orderDetail->quantity, 0, ',', '.') . " ₫"   }}</div>
                                </div>
                            </div>
                        </div>
                            <!-- Modal -->
                            <div class="modal fade bd-example-modal-lg-{{$orderDetail->id}}" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog  modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Mã đơn hàng: {{$orderDetail->id}}</h5>
                                        ...
                                        <div class="modal-body">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5> {{ number_format($orderDetail->price, 0, ',', '.') . " ₫"   }}</h5>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5>{{ App\Common\Constants::STATUS_ORDER[$orderDetail->order->status] }}</h5>
                                                    </td>
                                                    <td>
                                                        <h5>  {{ number_format($orderDetail->price * $orderDetail->quantity, 0, ',', '.') . " ₫"   }}</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-lg-12">
                                                                <div class="shoping__checkout">
                                                                    <ul>
                                                                        <li>Tổng tiền tạm tính <span>{{ number_format($orderDetail->price * $orderDetail->quantity, 0, ',', '.') . " ₫"   }}</span></li>
                                                                        <li>Giảm giá <span> - 0 ₫</span></li>
                                                                        <li>Tổng tiền thanh toán <span>{{ number_format($orderDetail->price * $orderDetail->quantity, 0, ',', '.') . " ₫"   }}</span></li>
                                                                        <li>Phương thức thanh toán
                                                                            <span>{{ $orderDetail->order->payment_method == "card" ? "Đã thanh toán thẻ" : "Thanh toán khi nhân hàng" }}</span>
                                                                        </li>
                                                                        <li>Trạng thái <span>{{ App\Common\Constants::STATUS_ORDER[$orderDetail->order->status] }}</span></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-lg-12">
                                                                <div class="shoping__checkout">
                                                                    <ul>
                                                                        <li>Tên khách hàng <span>{{$orderDetail->order->fullname}}</span></li>
                                                                        <li>Số điện thoại <span>{{$orderDetail->order->phone}}</span></li>
                                                                        <li>Địa chỉ giao hàng <span>{{$orderDetail->order->address}}</span></li>
                                                                        <li>Ghi chú  <span>{{$orderDetail->order->note}}</span></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
...
<style>
    .square {
        width: 2%; /* Đặt độ rộng của hình vuông */
        height: 18px; /* Đặt chiều cao của hình vuông */
    ...
    .B2SOGC, .Mr26O7, .UDaMW3 {
        margin: 0 0 0 8px;
    }
    .B2SOGC>.stardust-button:not(.stardust-button--primary), .Mr26O7>.stardust-button:not(.stardust-button--primary) {
        border: 1px solid rgba(0, 0, 0, .09);
        color: #555;
    }
    .B2SOGC>.stardust-button, .Mr26O7>.stardust-button {
    ...
    .B2SOGC>.stardust-button>span, .Mr26O7>.stardust-button>span {
        margin: 0 0 0 4px;
    }
    a:active, a:hover {
        outline: 0;
