                            ...
                            <div class="card mb-5" data-toggle="modal"
                                ...
                                <div class="card-footer text-muted">
                                    <div class="NWUSQP">
                                        ...
                                        <label class="juCcT0">Giảm giá:</label>
                                        <div class="t7TQaf mr-5" tabindex="0"> {{ number_format($orderDetail->discount, 0, ',', '.') . ' ₫' }} </div>
                                        @endif
                                        <span class="R_ufN9">
                                        ...
                                        <div class="t7TQaf" tabindex="0"
                                            aria-label="Thành tiền: {{ number_format(($orderDetail->price * $orderDetail->quantity)-$orderDetail->discount, 0, ',', '.') . ' ₫' }}">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="shoping__checkout">
                                                                    <ul>
                                                                        ...
                                                                        <li>Giảm giá <span> - {{ number_format($orderDetail->discount, 0, ',', '.') . ' ₫' }}</span></li>
                                                                        <li>Thành tiền
                                                                            <span>{{ number_format(($orderDetail->price * $orderDetail->quantity)-$orderDetail->discount, 0, ',', '.') . ' ₫' }}</span>
                                                                        </li>
                                                                        <li>Thời gian đặt
