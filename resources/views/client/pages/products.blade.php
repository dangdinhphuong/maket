...
@section('content')
    ...
    <section>
        <div class="breadcrumb__option container">
            <a href="{{ route('home') }}" >
                <span style="color:rgb(128, 128, 137); font-weight: 400;">Trang chủ <i style="color:rgb(128, 128, 137); font-size: small;" class=" pl-1 fa fa-chevron-right"></i>
                </span>
            </a>
            @if ($categories_slug != '')
                <span style="color:#27272a; font-weight: 400;">Kết quả tìm kiếm "{{ $categories_slug->nameCate }}"</span>
            @elseif (!empty(request('search')))
                <span style="color:#27272a; font-weight: 400;">Kết quả tìm kiếm "{{ request('search') }}"</span>
            @endif
        </div>
    </section>
                <!-- Breadcrumb Section End -->
                <!-- Product Section Begin -->
                <section class="product spad" style="    padding-top: 7px;">
